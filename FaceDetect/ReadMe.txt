================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : FaceDetect Project Overview
===============================================================================

The application wizard has created this FaceDetect application for
...
FaceDetectDlg.h, FaceDetectDlg.cpp - the dialog
    ...
    in FaceDetect.rc, which can be edited in Microsoft Visual C++.
